...
This project demonstrates a cutting-edge Spec-Driven Development (SDD) workflow leveraging Google Antigravity and Gemini. The system automates the transition from high-level documentation to a fully functional Java-based application. 
